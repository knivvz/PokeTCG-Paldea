...
; return NUM_CARDS in bc, minus 1 if FEZANDIPITY_EX or MEW_LV15 has not been collected (minus 2 if neither)
...
.skip
	...
	ld bc, NUM_CARDS
	ld hl, sCardCollection + FEZANDIPITY_EX
	bit CARD_NOT_OWNED_F, [hl]
	jr z, .has_venusaur_lv64
	dec bc
.has_venusaur_lv64
	ld hl, sCardCollection + MEW_EX
	bit CARD_NOT_OWNED_F, [hl]
	jr z, .has_mew_lv15
	dec bc
.has_mew_lv15

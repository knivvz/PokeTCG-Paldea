AIActionTable_BlisteringPokemon:
	dw .do_turn ; unused
	dw .do_turn
	dw .start_duel
	dw .forced_switch
...
AIDecide_NestBall_BlisteringPokemon:
	ld a, ORTHWORM_EX
...
AIDecide_UltraBall_BlisteringPokemon:
	or a
    ret

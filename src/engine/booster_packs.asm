...
CardTypeTable:
	...
	db BOOSTER_CARD_TYPE_COLORLESS   ; TYPE_PKMN_DARKNESS
	db BOOSTER_CARD_TYPE_COLORLESS   ; TYPE_PKMN_METAL
	db BOOSTER_CARD_TYPE_COLORLESS   ; TYPE_PKMN_FAIRY
	db BOOSTER_CARD_TYPE_COLORLESS   ; TYPE_PKMN_DRAGON
	...
	db BOOSTER_CARD_TYPE_ENERGY  ; TYPE_ENERGY_FAIRY
	...
	;db BOOSTER_CARD_TYPE_TRAINER_SUPPORTER   ; TYPE_TRAINER_SUPPORTER

...
DEF FILTER_METAL	 EQUS "TYPE_PKMN_METAL"
DEF FILTER_FAIRY	 EQUS "TYPE_PKMN_FAIRY"
DEF FILTER_DRAGON	 EQUS "TYPE_PKMN_DRAGON"
DEF FILTER_COLORLESS EQUS "TYPE_PKMN_COLORLESS"
DEF FILTER_TRAINER   EQUS "TYPE_TRAINER"

;DEF FILTER_TRAINER_SUPPORTER EQUS "TYPE_TRAINER_SUPPORTER"
DEF FILTER_ENERGY    EQU $30
DEF FILTER_DECK		 EQU $40

DEF NUM_FILTERS EQU 14 ; keeping this as an even number even if there's an odd number of filters will make your life so much easier
